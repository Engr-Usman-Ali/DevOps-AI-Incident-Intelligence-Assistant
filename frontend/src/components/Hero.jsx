...
export default function Hero() {
  return (
    <section id="home" className="relative overflow-hidden pt-36 pb-28">
      {/* Background Glow */}
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <h1 className="text-5xl lg:text-6xl font-black mt-8 leading-tight">
            Detect
            <span className="text-blue-500"> Incidents</span>
            <br />
            Before They Become
            <span className="text-cyan-400"> Disasters</span>
          </h1>

          <p className="mt-8 text-gray-400 leading-8 text-lg">
            Upload Linux, Docker or Kubernetes logs. Our AI automatically
            analyzes incidents, identifies root causes, recommends solutions,
        ...
        >
          <div className="bg-slate-900 rounded-3xl border border-slate-800 p-8 shadow-2xl">
            <div className="flex justify-between">
              <h3 className="font-bold text-xl">AI Incident Report</h3>
            ...
            <div className="mt-8">
              ...
              <div className="mt-6 space-y-5">
                ...
                <div>
                  ...
                  <p className="mt-2">96%</p>
                </div>

                <div>
                  <p className="text-gray-400">Suggested Fix</p>
